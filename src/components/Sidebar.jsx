...
const Sidebar = () => {
    ...
    return (
        <div>
            <div className={`bg-secundary-100 xl:h-[100vh] overflow-y-scroll 
              fixed xl:static w-[80%] md:w-[40%] lg:w-[30%] xl:w-auto h-full top-0 flex flex-col xl:items-center justify-between z-50 ${showMenu ?
                    "left-0" : "-left-full"} transition-all`}>
                <div> {/* <span></span> */}
                    {/************************* LOGO *************************/}
