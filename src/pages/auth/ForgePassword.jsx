    ...
    return (
        <div className="min-h-screen flex items-center justify-center">
            <div className="bg-secundary-100 p-8 rounded-xl m-2 w-auto lg:w-[470px]">
                <h1 className="text-2xl uppercase font-bold tracking-[5px] text-white my-8">
                    Recuperar 
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <span className="flex items-center gap-3">
                        ¿Ya tienes cuenta?
                        <Link to="/login" className="text-primary font-bold hover:text-gray-100 transition-colors">
                            Ingresa</Link>
                    </span>
                    <span className="flex items-center gap-3">
                        ¿No tienes cuenta?
